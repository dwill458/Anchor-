...
type NavigationProp = NativeStackNavigationProp<PracticeStackParamList, 'DeepPrimeCompletion'>;
type RouteProps = RouteProp<PracticeStackParamList, 'DeepPrimeCompletion'>;

export const DeepPrimeCompletionScreen: React.FC = () => {
  ...
  const preset = PRACTICE_COMPLETION_PRESETS.deep_prime;
  ...
  const handleRepeat = useCallback(() => {
    startPractice({
      mode: 'deepPrime',
      anchorId,
      source: source ?? 'practice_deep_prime_card',
      durationSeconds,
      chartContext,
    });
