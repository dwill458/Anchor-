...
export const REFINE_STYLES: RefineStyleOption[] = [
  ...
  },
  {
    ...
    generationStyle: 'midnight_bloom',
    family: 'SYMBOLIC',
    category: 'seasonal',
    glyph: 'bloom',
