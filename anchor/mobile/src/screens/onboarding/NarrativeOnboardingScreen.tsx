...
const SLIDES: OnboardingSlide[] = [
  ...
  },
  {
    ...
    body: 'The intention is there. What is missing is a cue you can return to on command.',
    visual: 'signal',
    cta: 'NEXT',
  },
  {
    id: 2,
    label: 'Make it yours',
    headline: 'Build an anchor **specific to you.**',
    body: '',
    visual: 'personalize',
    cta: 'CONTINUE',
  },
  {
    ...
    body: 'Anchor turns your intention into a distinct visual cue.\n\nReturning to the symbol reinforces the pattern of the intention you have chosen.',
    visual: 'forge',
    cta: 'NEXT',
  },
  {
    ...
    body: 'Return before the moment that matters, or whenever you need to reconnect with where you are going.',
    visual: 'practice',
    cta: 'NEXT',
  },
  {
