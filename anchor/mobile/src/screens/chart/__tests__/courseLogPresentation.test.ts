...
describe('Course Log presentation', () => {
  it('renders every frozen CourseEventType safely', () => {
    expect(Object.keys(COURSE_EVENT_COPY).sort()).toEqual([
      'COURSE_ARCHIVED', 'COURSE_COMPLETED', 'COURSE_CREATED', 'COURSE_RESTORED', 'DESTINATION_ANCHOR_LINKED', 'DESTINATION_CHANGED', 'MOVE_COMPLETED', 'PRACTICE_COMPLETED', 'REFLECTION_ADDED', 'ROUTE_ADJUSTED', 'WAYPOINT_ADDED', 'WAYPOINT_ANCHOR_LINKED', 'WAYPOINT_BLOCKED', 'WAYPOINT_CANCELLED', 'WAYPOINT_REACHED', 'WAYPOINT_REORDERED', 'WAYPOINT_SKIPPED', 'WAYPOINT_UNBLOCKED',
    ]);
