...
export const colors = {
  ...
  anchor15: {
    ...
    navBackground: 'rgba(20, 21, 20, 0.90)',
    navBorder: 'rgba(222, 191, 125, 0.18)',
    navActive: '#EDE5D6',
    navInactiveIcon: '#888681',
    navInactiveLabel: '#8F8B83',
    navPillBg: 'rgba(224, 211, 185, 0.12)',
    navPillBorder: 'rgba(239, 211, 150, 0.28)',
    navHalo: 'rgba(222, 191, 125, 0.09)',
  },
  // Primary Colors
  charcoal: '#1A1A1D',
  navy: '#0F1419',
