...
import { normalizeChartPracticeContext } from '@/navigation/practiceEntry';
...
describe('mobile practiceEntrySource matches the frozen backend contract', () => {
  ...
  it('emits the exact frozen value from the Chart waypoint surface', () => {
    ...
    expect(context?.practiceEntrySource).toBe('chart_waypoint_detail');
  });
