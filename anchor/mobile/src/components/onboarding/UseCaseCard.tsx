...
const ANCHOR_IMAGES: Record<UseCaseItem['iconType'], number> = {
  code: require('../../../assets/onboarding_anchor.png') as number,
  lift: require('../../../assets/physical_anchor_onboarding.png') as number,
  pitch: require('../../../assets/high_stakes_onboarding_anchor.png') as number,
};
