...
const styles = StyleSheet.create({
  ...
  sectionLabel: { ...typography.labelSM, color: colors.text.secondary },
  ...
  cardSelected: { borderColor: colors.text.primary, borderWidth: 1.5, backgroundColor: '#F6F0E4' },
  thumb: { borderRadius: 10, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', marginBottom: spacing[1] },
  cardTitle: { ...typography.labelMD, color: colors.text.primary },
  ...
  originalSelected: { borderColor: colors.text.primary, borderWidth: 1.5, backgroundColor: colors.grouped },
