...
export const TEACHINGS: Record<string, TeachingContent> = {
  ...
  distillation_first_time_v1: {
    ...
    guideOnly: true,
    tier: 'both',
    copy: 'Your sentence compresses into a visual form.',
  ...
  practice_thread_strength_v1: {
    ...
    copy: "Thread Strength shows how recently you have returned. It can fade and rebuild.",
    pattern: 'glass_card',
    tone: 'grounding',
    maxShows: 1,
    cooldownMs: 0,
  ...
  vault_intro_first_time_v1: {
    ...
    guideOnly: true,
    tier: 'both',
    title: 'Personal symbol',
    copy: 'An anchor turns one intention into a visual cue. Each time you return to it, you reconnect with the goal and strengthen the path back to action.',
    pattern: 'glass_card',
    tone: 'grounding',
    maxShows: 1,
    cooldownMs: 0,
  ...
  anchor_reuse_v1: {
    ...
    guideOnly: true,
    tier: 'both',
    copy: "You do not need a new anchor every time your focus fades. Returning to the same symbol trains recognition and turns your anchor into a reliable cue for action.",
    pattern: 'bottom_hint',
    tone: 'grounding',
    maxShows: 1,
    cooldownMs: 0,
