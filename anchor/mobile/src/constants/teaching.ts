...
export const TEACHINGS: Record<string, TeachingContent> = {
  ...
  anchor_reuse_v1: {
    ...
    guideOnly: true,
    tier: 'both',
    copy: "You don’t need a new anchor every time your focus fades. Returning to the same symbol helps train recognition, build emotional weight, and turn your anchor into a reliable cue for action.",
    pattern: 'bottom_hint',
    tone: 'grounding',
    maxShows: 1,
    cooldownMs: 0,
