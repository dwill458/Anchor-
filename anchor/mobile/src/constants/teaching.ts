...
export const TEACHINGS: Record<string, TeachingContent> = {
  ...
  activation_ground_note_v1: {
    ...
    guideOnly: true,
    tier: 'both',
    copy: 'Look at the anchor. Let the intention settle.',
  ...
  confirm_burn_release_v1: {
    ...
    guideOnly: true,
    tier: 'both',
    copy: 'The act of spelling it out is part of the practice. It asks for your full attention.',
    pattern: 'inline_whisper',
    tone: 'whisper',
    maxShows: 1,
    cooldownMs: 0,
  ...
  milestone_first_anchor_v1: {
    ...
    guideOnly: false,
    tier: 'both',
    copy: "Your first anchor is set. Begin the first prime when you're ready.",
    pattern: 'toast_achievement',
    tone: 'encouragement',
    maxShows: 1,
    cooldownMs: 0,
