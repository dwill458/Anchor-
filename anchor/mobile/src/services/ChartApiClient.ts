...
export class ChartApiClient {
  ...
  generateCoursePlan(
    ...
    signal?: AbortSignal,
  ): Promise<ChartApiResult<CoursePlanProposal>> {
    return this.unwrap(() =>
      apiClient.post('/api/course-plans', request, this.requestConfig(signal)),
    );
  }
  ...
  getCoursePlanQuota(signal?: AbortSignal): Promise<ChartApiResult<CoursePlanQuota>> {
    return this.unwrap(() =>
      apiClient.get('/api/course-plans/quota', this.requestConfig(signal)),
    );
  }
  ...
  getCoursePlan(
    ...
    return this.unwrap(() =>
      apiClient.get(`/api/course-plans/${encodePath(proposalId)}`, this.requestConfig(signal)),
    );
  }
  ...
  acceptCoursePlan(
    ...
    return this.unwrap(() =>
      apiClient.post(
        `/api/course-plans/${encodePath(proposalId)}/accept`,
        { idempotencyKey },
        this.requestConfig(signal),
      ),
    );
